...
<head>
  ...
  <link rel="stylesheet" href="<?= css_url('landing.css')?>" type="text/css" />
  ...
  <!--[if lt IE 9]>
    ...
    <script src="<?= js_url('js/ie/excanvas.js') ?>"></script>
  <![endif]-->
</head>
<body class="">
  ...
  <header id="header" class="navbar navbar-fixed-top bg-white box-shadow b-b b-light"  data-spy="affix" data-offset-top="1">
    <div class="container">
      <div class="navbar-header">
        <a href="#" class="navbar-brand"><img src="<?= image_url('logo.png') ?>" class="m-r-sm"><span class="text-muted">Textrr</span></a>
        ...
        <div class="hbox">
              ...
              <section class="panel bg-dark inline m-b-n-lg m-r-n-lg aside-sm no-border device phone animated fadeInLeftBig">
                ...
                <div>
                  <div class="m-l-xs m-r-xs">
                    <img src="<?= image_url('phone-2.png') ?>" class="img-full" >
                  </div>
                </div>
              </section>
            </div>
          ...
          <aside class="col-sm-10 col-md-6">
            <section class="panel bg-dark m-b-n-lg no-border device animated fadeInUp">
              ...
              <img src="<?= image_url('main.png') ?>" class="img-full" >
            </section>
          </aside>
          <aside class="col-md-3 v-bottom">
            <div class="hidden-sm hidden-xs">
              <section class="panel bg-light m-b-n-lg m-l-n-lg aside no-border device phone animated fadeInRightBig">
                ...
                <div class="">
                  <div class="m-l-xs m-r-xs">
                    <img src="<?= image_url('phone-1.png') ?>" class="img-full" >
                  </div>
                </div>
              </section>
            </div>
  ...
  <!-- / footer -->  <script src="<?= js_url('jquery.min.js') ?>"></script>
  <!-- Bootstrap -->
  ...
  <script src="<?= js_url('appear/jquery.appear.js') ?>"></script>
  <script src="<?= js_url('scroll/smoothscroll.js') ?>"></script>
